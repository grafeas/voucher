...
func TestGetAllCheckSuites(t *testing.T) {
	getAllCheckSuitesTests := []struct {
	...
	}{
		{
			...
			commitURL: "https://github.com/grafeas/voucher/v2/commit/881e9fd71e816415e1f199daeb6dc6d3c5fd4f2c",
			input: func() *commitInfoQuery {
				res := new(commitInfoQuery)
				res.Resource.Typename = "Commit"
				res.Resource.Commit.URL = "https://github.com/grafeas/voucher/v2/commit/881e9fd71e816415e1f199daeb6dc6d3c5fd4f2c"
		...
		},
		{
			...
			commitURL: "https://github.com/grafeas/voucher/v2/commit/8c235f3bd57393c53037b032e6da3e2b48aa0428",
			input: func() *commitInfoQuery {
				res := new(commitInfoQuery)
				res.Resource.Typename = "Commit"
				res.Resource.Commit.URL = "https://github.com/grafeas/voucher/v2/commit/8c235f3bd57393c53037b032e6da3e2b48aa0428"
				res.Resource.Commit.CheckSuites.Nodes = []checkSuite{
					{
						Status:     "COMPLETED",
						Conclusion: "SUCCESS",
				...
				res.Resource.Commit.AssociatedPullRequests.Nodes = []pullRequest{
					{
						...
						Merged:      true,
						MergeCommit: commit{
							URL: "https://github.com/grafeas/voucher/v2/commit/8c235f3bd57393c53037b032e6da3e2b48aa0428",
						},
						URL: "https://github.com/grafeas/voucher/v2/pull/23",
					},
				}
				res.Resource.Commit.AssociatedPullRequests.PageInfo.HasNextPage = false
				return res
...
func TestConvertPullRequests(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			pullRequestURL: "https://github.com/grafeas/voucher/v2/pull/23",
			pullRequests: []pullRequest{
				{
					BaseRefName: "master",
					HeadRefName: "fix-broken-response",
